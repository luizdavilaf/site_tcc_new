    ...
    try {
        ...
        const eleicoes = data.candidatoEleicaos.map(eleicao => {
           ...
           return {
               ...
               situacao_turno: eleicao.situacaoTurno.nome || "sem nome",
               unidade_eleitoral: `${eleicao.unidadeEleitoral.sigla} - ${eleicao.unidadeEleitoral.nome || "sem nome"}`,
               ocupacao: eleicao.ocupacao.nome_ocupacao,
               grau_de_instrucao: eleicao.grauDeInstrucao.nome_instrucao,
               situacao_candidatura: eleicao.situacaoCandidatura.nome || "sem nome",
